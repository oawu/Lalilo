      ...
      Object.assign(GoogleMap.Marker.prototype, {
        ...
        onDrag (func) {
          ...
          this._vue.drag = {
            ...
            mousemove: null,
            func,
            default: this.map ? this.map.get('draggable') : false
          }
          ...
          this._vue.events.mousedown = e => {
            ...
            this._vue.drag.mousemove = this.getMap().getDiv().addEventListener('mousemove', e => {
              ...
              this._vue.drag.clickAble = false
        ...
        onClick (val) {
          ...
          let that = this
          this._vue.events.click = e => this._vue.drag.clickAble && val.call(this, this.position, this, e)
          return this
        },
        onDblClick (val) {
          if (typeof val != 'function') {
          ...
          let that = this
          this._vue.events.dblclick = e => this._vue.drag.clickAble && val.call(this, this.position, this, e)
          return this
        },
        onEvents (val) {
